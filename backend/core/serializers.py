...
class SiteSettingsSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            "club_hero_kicker", "club_hero_heading", "club_hero_script", "club_hero_lead",
            "club_bento_1_img", "club_bento_1_badge", "club_bento_1_title", "club_bento_1_sub",
            "club_bento_2_img", "club_bento_2_badge", "club_bento_2_title", "club_bento_2_sub",
            "club_bento_3_img", "club_bento_3_badge", "club_bento_3_title", "club_bento_3_sub",
            "club_pass_title", "club_pass_sub", "club_pass_badge",
            "club_benefit_1_badge", "club_benefit_1_title", "club_benefit_1_desc",
            "club_benefit_2_badge", "club_benefit_2_title", "club_benefit_2_desc",
            "club_benefit_3_badge", "club_benefit_3_title", "club_benefit_3_desc",
